...
with open(run_id + '/log_file.csv', 'w') as log_fil:
    ...
    log_fil.write("epoch,epoch duration,train loss,valid loss,train dice,valid dice\n")
    ...
    for epoch in range(0, num_epochs):
        ...
        valid_dice.append(epoch_valid_dice)
        train_count.append(epoch_train_count)
        valid_count.append(epoch_valid_count)


# save best weights
        if epoch_valid_loss < high_loss:
            high_loss = epoch_valid_loss
        ...
        log_fil.write(str(epoch) + ',' + str(epoch_time) + ',' + str(epoch_train_loss) + ',' + str(epoch_valid_loss) + ',' + str(epoch_train_dice) + ',' + str(epoch_valid_dice) + '\n' )
